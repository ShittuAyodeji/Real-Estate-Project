...
<p class="h2 page_title main-page-title float-left" style="width:100%; margin-top:170px;">Letting or Renting</p>
...
<?php 
$related_sql=$dbc->prepare("SELECT * FROM properties WHERE treated='1' AND status='Rent' LIMIT 8");
$related_sql->execute();
...
<p class="h2" style="text-align:center;"><strong>Properties For Rent</strong></p>
</div>
<?php
if($related_rows>0){
