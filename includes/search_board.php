					<div class="advanced-search container-fluid sec-adv-search">
				<div class="row alert-container">
				<div class="col-sm-12 col-xs-12 float-left" style="width:100%; padding:0;">
...
<div class="col-sm-12 col-md-12 col-lg-2 col-12 filter-col property-col">
    <span class="filter-indicator fa fa-chevron-up up-indicator"></span>
    <span class="filter-indicator fa fa-chevron-down down-indicator"></span>
<p class="h4 regions-head head p-1 deeper">SELECT PROPERTY</p>
		...
		<li class="list-group-item" data-status="check" data-type="property" data-value="Bar and Restuarant"><i class="fa fa-square-o check"></i> Bar and Restuarant</li>
		<li class="list-group-item" data-status="check" data-type="property" data-value="Shopping Centre"><i class="fa fa-square-o check"></i> Shopping Centre</li>
		<li class="list-group-item" data-status="check" data-type="property" data-value="Sport Venue"><i class="fa fa-square-o check"></i> Sport Venue</li>
		<li class="list-group-item" data-status="check" data-type="property" data-value="Tourist Attraction"><i class="fa fa-square-o check"></i> Tourist Attraction</li>
	...
	<div class="col-lg-2 col-sm-12 col-md-12 col-12 houses house-type types-of filter-col">
	    <span class="filter-indicator fa fa-chevron-up up-indicator"></span>
    <span class="filter-indicator fa fa-chevron-down down-indicator"></span>
					<p class="h4 head deeper">SELECT HOUSE TYPE</p>
...
<div class="col-sm-12 col-md-12 col-lg-2 col-12 filter-col">
    <span class="filter-indicator fa fa-chevron-up up-indicator"></span>
    <span class="filter-indicator fa fa-chevron-down down-indicator"></span>
				<p class="h4 regions-head head p-1 deeper">SELECT REGION</p>
...
<div class="col-lg-2 col-sm-12 col-md-12 col-12 filter-col">
    <span class="filter-indicator fa fa-chevron-up up-indicator"></span>
    <span class="filter-indicator fa fa-chevron-down down-indicator"></span>
	<p class="h4 head p-1 deeper">SELECT CITY IN <span class="towns-head"></span></p>
	<ul class="list-group towns">
					...
					<label for="increase">(+ or -) price by:</label>
					</div>
